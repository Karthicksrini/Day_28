                ...
                <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item dropdown no-arrow mx-1">
                            <div className="nav-link dropdown-toggle" href="/#" id="alertsDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        {/* {/* Nav Item - Messages --> */}
                        <li className="nav-item dropdown no-arrow mx-1">
                            <div className="nav-link dropdown-toggle" href="/#" id="messagesDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <div className="dropdown-item text-center small text-gray-500" href="/#">Read More Messages</div>
                            </div>
                        </li>
                        ...
                        <li className="nav-item dropdown no-arrow">
                            <div className="nav-link dropdown-toggle" href="/#" id="userDropdown" role="button"
                                ...
                                <img className="img-profile rounded-circle"
                                   alt="img" src="img/undraw_profile.svg"/>
                            </div>
